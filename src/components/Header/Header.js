const Header = () => {
    return (
        <header className="w-full h-14 p-4 bg-yt-dark flex items-center">
            <div className="flex items-center space-x-6">
                <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-4 stroke-white stroke-2 cursor-pointer"
                >
                    <line
                        x1="1"
                        y1="19"
                    ...
                    <line
                        ...
                        strokeLinecap="round"
                    />
                    <line x1="1" y1="1" x2="26" y2="1" strokeLinecap="round" />
                </svg>
                <svg viewBox="0 0 90 20" className="w-24 cursor-pointer">
                    <g viewBox="0 0 90 20">
                        <g>
                            <path
            ...
            <div className="flex items-center flex-1 justify-end sm:justify-center">
                <div className="items-center w-full h-full justify-center hidden ml-28 max-w-2xl md:flex">
                    <input
                        type="text"
                        name="search"
                        id="search"
                        placeholder="Search"
                        className="border-[0.16rem] border-yt-gray px-2 bg-yt-main-bg h-10 text-white outline-none w-full placeholder:font-roboto"
                    />
                    <button className="h-10 bg-yt-gray px-5 text-white">
                        <i className="ri-search-line font-light bg-yt-gray text-xl"></i>
                    </button>
                    <i className="ri-mic-fill h-10 leading-none cursor-pointer text-white p-3 bg-yt-searchbox-bg mx-3 rounded-full"></i>
                </div>
            </div>
            <div className="flex items-center space-x-5 text-xl text-white ml-6">
                <i className="ri-grid-line cursor-pointer"></i>
                <i className="ri-more-2-line cursor-pointer"></i>
            </div>
            <button className="flex items-center space-x-2 font-roboto text-sm uppercase rounded-sm text-yt-border-blue border-yt-border-blue border-[0.1rem] h-10 px-3 ml-3">
                <i className="ri-user-3-line p-0"></i>
